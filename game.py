...
def reset_ball():
    return random.randint(ball_radius, SCREEN_WIDTH - ball_radius), 0
...
def game_over():
    ...
    return 0, 3  # Reset score and ball speed
...
while running:
    ...
    # Collision detection
    if (platform_x < ball_x < platform_x + platform_width and 
        platform_y - ball_radius < ball_y < platform_y + platform_height):
